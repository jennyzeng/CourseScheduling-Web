from CourseScheduling.blueprints.schedule.dbHelper import getInfo, getMajorsNames, getMajorSpecsByName, getQuarterCodes, getSchedule
...
def launch():
    ...
    courses_preview = getSchedule(upper_units, max_widths, startQ, avoid, taken, spec, ge_filter, majors)
